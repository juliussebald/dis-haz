...
eco <- raster::shapefile("materials/raw_data/shapefiles_ecological_units/WLamPoly.shp") # add this line to "Load data" section
...
eco_ws$eco_unit <-  as.factor(eco_ws$eco_unit)

summary(eco_ws)

write_csv(eco_ws, "methods/r/data_processed/dataframes/temp/eco_ws.csv")
eco_ws <- read.csv(eco_ws, "methods/r/data_processed/dataframes/temp/eco_ws.csv")
